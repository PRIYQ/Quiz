...
public class Quiz implements ActionListener
	{
	String questions[]= {
							"Q 1 - Which Company created JAVA?",
							"Q 2 - What is static block?",
							"Q 3 - What is the default value of int variable?",
							"Q 4 - Which of the following is Faster, StringBuilder or StringBuffer?",
							...
							"Q 9 - What does the expression float a = 35 / 0 return?",
						   "Q 10 - Which package contains the Random class?"
						};
	String options[][]= {
						{"Sun Microsystems","Starbucks","Microsoft","Alphabets"},
						{"It is used to create syncronized code.","There is no such block.",
...
public void actionPerformed(ActionEvent e) 
	...
	public Quiz()
	{
		...
		buttonA.setFont(new Font("MV Boli",Font.BOLD,45));
		buttonA.setFocusable(false);
		buttonA.addActionListener(this);
		buttonA.setText("A");
		
		buttonB.setBounds(0,200,100,100);
		buttonB.setFont(new Font("MV Boli",Font.BOLD,45));
		buttonB.setFocusable(false);
		buttonB.addActionListener(this);
		buttonB.setText("B");
		
		buttonC.setBounds(0,300,100,100);
		buttonC.setFont(new Font("MV Boli",Font.BOLD,45));
		buttonC.setFocusable(false);
		buttonC.addActionListener(this);
		buttonC.setText("C");
		
		buttonD.setBounds(0,400,100,100);
		buttonD.setFont(new Font("MV Boli",Font.BOLD,45));
		buttonD.setFocusable(false);
		buttonD.addActionListener(this);
		buttonD.setText("D");
		
		answer_labelA.setBounds(125,100,800,100);
		answer_labelA.setBackground(new Color(50,50,50));
		answer_labelA.setForeground(new Color(25,255,0));
		answer_labelA.setFont(new Font("MV Boli",Font.PLAIN,35));
	
		
		answer_labelB.setBounds(125,200,800,100);
		answer_labelB.setBackground(new Color(50,50,50));
		answer_labelB.setForeground(new Color(25,255,0));
		answer_labelB.setFont(new Font("MV Boli",Font.PLAIN,35));
		
		
		answer_labelC.setBounds(125,300,850,100);
		answer_labelC.setBackground(new Color(50,50,50));
		answer_labelC.setForeground(new Color(25,255,0));
		answer_labelC.setFont(new Font("MV Boli",Font.PLAIN,35));
		
		
		answer_labelD.setBounds(125,400,800,100);
		...
		seconds_left.setHorizontalAlignment(textField.CENTER);		
		seconds_left.setText(String.valueOf(seconds));
